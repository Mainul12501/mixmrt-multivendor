...
Route::group(['namespace' => 'Api\V1', 'middleware'=>'localization'], function () {
    ...
    Route::group(['prefix' => 'delivery-man'], function () {
        ...
        Route::group(['middleware'=>['dm.api']], function () {
            ...
            Route::post('make-collected-cash-payment-offline', 'DeliverymanController@make_payment_offline')->name('make_payment_offline');
            Route::get('offline-payment-list', 'DeliverymanController@offline_payment_list')->name('offline_payment_list');
...
//            get dm trans history
    ...
    Route::group(['prefix' => 'vendor', 'namespace' => 'Vendor', 'middleware'=>['vendor.api']], function () {
        ...
        Route::post('make-collected-cash-payment-offline', 'VendorController@make_payment_offline')->name('make_payment_offline');
        Route::get('offline-payment-list', 'VendorController@offline_payment_list')->name('offline_payment_list');
        ...
        Route::post('third-party-company', 'VendorController@third_party_company')->name('third-party-company');
