    ...
    <div class="content container-fluid config-inline-remove-class">
        ...
        <div class="card mb-3">
            ...
            data-original-title="{{translate('messages.minimum_processing_time_warning')}}"><img src="{{asset('/public/assets/admin/img/info-circle.svg')}}" alt="{{translate('messages.minimum_processing_time_warning')}}"></span></label>
                     ...
                     <div class="col-sm-4 col-12">
                        <div class="form-group mt-3">
                            <label class="input-label text-capitalize" for="per_kg_charge">{{translate('messages.per_kg_charge')}} ({{\App\CentralLogics\Helpers::currency_symbol()}})</label>
                            <input type="number"  id="per_kg_charge" name="per_kg_charge" step="0.01" min="0" max="100000" class="form-control" placeholder="100" value="{{$store->per_kg_charge??'0'}}">
                            <input type="hidden"   name="module_type" class="form-control" placeholder="100" value="{{$store->module->module_type}}">
                        </div>
                    </div>
